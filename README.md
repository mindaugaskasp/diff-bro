...
| **Guided first run**     | Four coach marks over the real controls on a first launch — comparing, sealing, quick look-up, settings — then three more if you want them. Escape or Skip ends it for good; Help ▸ Show Tour brings it back.                                                                                                                                                                                                                                                                                                      |
