// UUIDs for the UUID tool: generate v1/v4/v5/v6/v7, inspect one, and move
// between the canonical 8-4-4-4-12 string and the 32-hex "binary" form (the
// BINARY(16) representation databases store). Pure, so it stays unit-testable.
